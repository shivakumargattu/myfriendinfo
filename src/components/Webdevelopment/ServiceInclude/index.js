  ...
  return(
    ...
    <div className=''>
      ...
      <div className='used-tech-card-cantainer'>
            ...
            <div className='technologie-used'>
              <img alt="imge" className='w-100' src="https://img.webcodegenie.com/img/technology-use/Jquery.svg?ver=20230620061009"/>
            </div>
          

            <div className='technologie-used'>
              <img alt="imge" className='w-100' src="https://img.webcodegenie.com/img/technology-use/mysql.svg?ver=20230620061009"/>
            </div>
...
Amazon SageMaker: Amazon SageMaker is a fully managed service by Amazon Web Services (AWS) that provides an end-to-end platform for building, training, and deploying machine learning models. It offers pre-built algorithms, distributed training, automatic model tuning, and hosting capabilities.
</p>
...
const Component6=()=>{
 ...
 <div className=''>
      ...
      <div className='technologie-used'>
            ...
            <div className='technologie-used'>
              <img alt="imge" className='w-100' src="https://img.webcodegenie.com/img/technology-use/NodeJs.svg?ver=20230608134812"/>
            </div>
