...
const Blog3 = () => {
  ...
  <div className='bg-blog-continer'>
      <div className='blogs-details-container'>
        ...
        <h3 className='m-3 mb-2 mt-2 ml-0 '><b>Building Data Analytics Software</b></h3>
        ...
        <div className='bottom-blog-continer'>
            <img src='https://myfriend.net.in/wp-content/uploads/2019/09/blog3.jpg' alt='imge' className='blog-imge'/>
            <p className='pt-3'>Building Data Analytics Software</p>

            <div>
            <h3><b>Building Data Analytics Software</b></h3>
