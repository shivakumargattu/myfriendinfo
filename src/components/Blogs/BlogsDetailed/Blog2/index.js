...
const Blog2 = () => {
  ...
  <div className='bg-blog-continer'>
      <div className='blogs-details-container'>
        ...
        <h3 className='m-3 mb-2 mt-2 ml-0 '><b>You have a Great Business Idea</b></h3>
        ...
        <div className='bottom-blog-continer'>
            <img src='https://myfriend.net.in/wp-content/uploads/2019/11/blog1.jpg' alt='imge' className='blog-imge'/>
            <p className='pt-3'>You have a Great Business Idea</p>

            <div>
            <h3><b>You have a Great Business Idea</b></h3>
