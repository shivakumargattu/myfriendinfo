...
const Blog4 = () => {
  ...
  <div className='bg-blog-continer'>
      <div className='blogs-details-container'>
        ...
        <h3 className='m-3 mb-2 mt-2 ml-0 '><b>How to Make Website WCAG Compliant?</b></h3>
        ...
        <div className='bottom-blog-continer'>
            <img src='https://myfriend.net.in/wp-content/uploads/2019/05/blog-slide3.jpg' alt='imge' className='blog-imge'/>
            <p className='pt-3'>How to Make Website WCAG Compliant?</p>

            <div>
            <h3><b>How to Make Website WCAG Compliant?</b></h3>
