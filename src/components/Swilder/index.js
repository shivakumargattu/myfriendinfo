...
const ImageSlider = () => {
  ...
  <div className="container ml-4 pt-3">
    ...
    <p className='deceripon-slider'>	Setting the foundation for success: expert requirement gathering in web and mobile app development - your vision, our solution!
...
<p className='deceripon-slider'>Launch your digital success story with confidence - our seamless deployment process delivers your web or mobile app to the world.</p>
  ...
  <h4><b>Quality Assurance</b></h4>
    <p className='silder-description'>Flawless performance, seamless user experience - our dedicated quality assurance team ensures your web or mobile app exceeds expectations.
